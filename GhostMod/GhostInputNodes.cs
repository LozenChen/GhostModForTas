...
public static class GhostInputNodes {
    ...
    public class Button : VirtualButton.Node {
        ...
        public override bool Pressed =>
            !MInput.Disabled && (Replayer.Frame.Input.Buttons & Mask) == Mask && (Replayer.PrevFrame.Input.Buttons & Mask) == 0;

        public override bool Released =>
            !MInput.Disabled && (Replayer.Frame.Input.Buttons & Mask) == 0 && (Replayer.PrevFrame.Input.Buttons & Mask) == Mask;
    }
}
}